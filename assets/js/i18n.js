...
const I18N = {
  ...
  en: {
    ...
    chartNoteAlertesJour:(lus,sans)=>`Alerts received by surveillance teams, day by day; the dark share is validated as a suspected case after verification. The axis follows the calendar: ${lus} days are recorded, the other ${sans} stay blank at their true width — no bulletin that day, or a bulletin that does not give both figures. A day's volume depends as much on search activity as on the outbreak: a quiet day may be a day without teams in the field.`,
  ...
  sw: {
    ...
    chartNoteAlertesJour:(lus,sans)=>`Tahadhari zilizopokelewa na timu za ufuatiliaji, siku kwa siku; sehemu nyeusi imethibitishwa kama kisa kinachoshukiwa baada ya uhakiki. Mhimili unafuata kalenda: siku ${lus} zimerekodiwa, siku ${sans} zilizobaki zinabaki wazi kwa upana wake halisi — hakuna ripoti siku hiyo, au ripoti isiyotoa namba zote mbili. Kiasi cha siku kinategemea shughuli za utafutaji kama kinavyotegemea mlipuko: siku yenye idadi ndogo yaweza kuwa siku bila timu uwanjani.`,
