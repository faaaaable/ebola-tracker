...
const I18N = {
  ...
  en: {
    ...
    chartNoteCteProvince:(seuilLits)=>`Hospitalised patients — confirmed and suspected — relative to the beds the bulletin declares for the province. Until early August the rate is recalculated from a table of patients and beds; since then it is the one the bulletin prints, even when it no longer gives the number of beds — the line then stops below ${seuilLits} patients, where a rate no longer means anything. When the bulletin stops counting all patients and keeps only those in standard-compliant facilities — North Kivu since 15 September — the line restores the earlier definition: all hospitalised patients relative to declared beds. Otherwise patients lying outside the planned beds would vanish from the very rate meant to signal them. Above 100%, patients are placed outside the planned beds. Dashed segments: gaps of five days or fewer, purely illustrative; longer gaps stay open, as the number of beds may have changed in between.`,
    ...
    chartNoteCte:(seuilLits)=>`Hospitalised patients — confirmed and suspected — relative to the beds the bulletin declares, province by province. Until early August the rate is recalculated from a table of patients and beds; since then it is the one the bulletin prints. Above 100%, patients are placed outside the planned beds. A province is drawn only from ${seuilLits} declared beds — or ${seuilLits} patients when the bulletin gives no bed count: below that, a rate means nothing. On 15 September the bulletin stops counting all of North Kivu's patients and keeps only those in standard-compliant facilities in the numerator, which drops its published rate from 152.6% to 94.7% while patient numbers rise: the 157 patients lying outside the planned beds — exactly what exceeding 100% is meant to signal — fell out of the calculation. The bed count itself never moved: 228 since 11 September. The line therefore restores the earlier definition, all hospitalised patients relative to declared beds. Dashed segments: gaps of five days or fewer, purely illustrative; longer gaps stay open, as the number of beds may have changed in between.`,
  ...
  sw: {
    ...
    chartNoteCteProvince:(seuilLits)=>`Wagonjwa waliolazwa — waliothibitishwa na wanaoshukiwa — ikilinganishwa na vitanda ambavyo ripoti inatangaza kwa jimbo. Hadi mwanzoni mwa Agosti kiwango kinahesabiwa upya kutoka jedwali la wagonjwa na vitanda; tangu wakati huo ni kile ripoti inachapisha, hata isipotoa tena idadi ya vitanda — mstari husimama chini ya wagonjwa ${seuilLits}, ambapo kiwango hakina maana tena. Ripoti inapoacha kuhesabu wagonjwa wote na kubakiza tu wale wa vituo vyenye viwango — Kivu Kaskazini tangu tarehe 15 Septemba — mstari unarejesha maana ya awali: wagonjwa wote waliolazwa ikilinganishwa na vitanda vilivyotangazwa. Vinginevyo wagonjwa waliolala nje ya vitanda vilivyopangwa wangetoweka kwenye kiwango kinachokusudiwa kuwaonyesha. Zaidi ya 100%, wagonjwa wanawekwa nje ya vitanda vilivyopangwa. Nukta: mapengo ya siku tano au chini, mchoro wa kuonyesha tu; mapengo marefu hubaki wazi, kwani idadi ya vitanda inaweza kuwa imebadilika.`,
    ...
    chartNoteCte:(seuilLits)=>`Wagonjwa waliolazwa — waliothibitishwa na wanaoshukiwa — ikilinganishwa na vitanda ambavyo ripoti inatangaza, jimbo kwa jimbo. Hadi mwanzoni mwa Agosti kiwango kinahesabiwa upya kutoka jedwali la wagonjwa na vitanda; tangu wakati huo ni kile ripoti inachapisha. Zaidi ya 100%, wagonjwa wanawekwa nje ya vitanda vilivyopangwa. Jimbo huchorwa tu kuanzia vitanda ${seuilLits} vilivyotangazwa — au wagonjwa ${seuilLits} wakati ripoti haitoi idadi ya vitanda: chini ya hapo, kiwango hakina maana. Tarehe 15 Septemba ripoti inaacha kuhesabu wagonjwa wote wa Kivu Kaskazini na kubakiza tu wale wa vituo vyenye viwango, hivyo kiwango kilichochapishwa kinashuka kutoka 152,6% hadi 94,7% wakati idadi ya wagonjwa inapanda: wagonjwa 157 waliolala nje ya vitanda vilivyopangwa — kile hasa kuzidi 100% kunakusudia kuonyesha — waliondolewa kwenye hesabu. Idadi ya vitanda haikubadilika: 228 tangu tarehe 11 Septemba. Kwa hiyo mstari unarejesha maana ya awali, wagonjwa wote waliolazwa ikilinganishwa na vitanda vilivyotangazwa. Nukta: mapengo ya siku tano au chini, mchoro wa kuonyesha tu; mapengo marefu hubaki wazi, kwani idadi ya vitanda inaweza kuwa imebadilika.`,
