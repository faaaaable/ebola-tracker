...
const I18N = {
  fr: {
    ...
    chartNoteCteProvince:(seuilLits)=>`Patients hospitalisés — confirmés et suspects — rapportés aux lits que le bulletin déclare pour la province. Jusqu'à début août le taux est recalculé depuis un tableau de patients et de lits ; depuis, c'est celui que le bulletin imprime, même quand il ne donne plus le nombre de lits — la courbe s'arrête alors sous ${seuilLits} patients, un taux n'y voulant plus rien dire. Quand le bulletin cesse de rapporter tous les patients à la capacité totale pour ne compter que les structures normées, le taux change de dénominateur sans que la situation change. Au-dessus de 100 %, des malades sont installés hors des lits prévus. Pointillés : trous de cinq jours au plus, tracé purement illustratif ; les trous plus longs restent ouverts, le nombre de lits ayant pu changer entre-temps.`,
    chartNoteCte:(seuilLits)=>`Patients hospitalisés — confirmés et suspects — rapportés aux lits que le bulletin déclare, province par province. Jusqu'à début août le taux est recalculé depuis un tableau de patients et de lits ; depuis, c'est celui que le bulletin imprime. Au-dessus de 100 %, des malades sont installés hors des lits prévus. Une province n'est tracée qu'à partir de ${seuilLits} lits déclarés — ou de ${seuilLits} patients quand le bulletin ne donne pas ses lits : en deçà, un taux ne veut rien dire. Le Nord-Kivu change de dénominateur le 15 septembre, le bulletin cessant de rapporter tous ses patients à sa capacité totale pour ne compter que ses structures normées : la chute de 152 à 95 % est ce changement, pas une décrue. Pointillés : trous de cinq jours au plus, tracé purement illustratif ; les trous plus longs restent ouverts, le nombre de lits ayant pu changer entre-temps.`,
  ...
  en: {
    ...
    chartNoteCteProvince:(seuilLits)=>`Hospitalised patients — confirmed and suspected — relative to the beds the bulletin declares for the province. Until early August the rate is recalculated from a table of patients and beds; since then it is the one the bulletin prints, even when it no longer gives the number of beds — the line then stops below ${seuilLits} patients, where a rate no longer means anything. When the bulletin stops relating all patients to total capacity and counts only standard-compliant facilities, the rate changes denominator without the situation changing. Above 100%, patients are placed outside the planned beds. Dashed segments: gaps of five days or fewer, purely illustrative; longer gaps stay open, as the number of beds may have changed in between.`,
    chartNoteCte:(seuilLits)=>`Hospitalised patients — confirmed and suspected — relative to the beds the bulletin declares, province by province. Until early August the rate is recalculated from a table of patients and beds; since then it is the one the bulletin prints. Above 100%, patients are placed outside the planned beds. A province is drawn only from ${seuilLits} declared beds — or ${seuilLits} patients when the bulletin gives no bed count: below that, a rate means nothing. North Kivu changes denominator on 15 September, the bulletin no longer relating all its patients to total capacity but counting only its standard-compliant facilities: the fall from 152 to 95% is that change, not a decline. Dashed segments: gaps of five days or fewer, purely illustrative; longer gaps stay open, as the number of beds may have changed in between.`,
